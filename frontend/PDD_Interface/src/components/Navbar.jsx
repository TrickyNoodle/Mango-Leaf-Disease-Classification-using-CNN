...
function Navbar({ darkmode, onDarkModeChange }) {
  return (
    <div
      className={`relative flex items-center sticky top-0 backdrop-blur-2xl w-full delius shadow-2xl pacifico-regular py-6 px-6 ${darkmode ? "bg-gray-800 text-white" : "bg-white text-gray-900"
        }`}
    >
